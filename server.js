...
bot.on("ready", async () => {
    ...
    `${bot.guilds.size} servers`,
     ...
     setInterval(() => {
        ...
        bot.user.setActivity(activities_list[index], {type: "STREAMING", url: "https://www.youtube.com/channel/UC96afyC25gnuT-xA0G4CEOQ?view_as=subscriber"}); // sets bot's activities to one of the phrases in the arraylist.
